export default function Info() {
  return (
    <div className="flex flex-col justify-center items-center text-center w-[75vw] min-w-[370px] gap-4">
      <h1 className="text-4xl mb-4">Postcode Checker v2</h1>
      ...
      <h4>
        ...
        <a href="https://www.gov.uk/find-local-council" className="text-[red]">
